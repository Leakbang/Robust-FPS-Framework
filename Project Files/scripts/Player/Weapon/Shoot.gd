...
func shoot():
	...
	var recoil = 0
	recoil = $RecoilTimer.time_left * bullet_spread * (1 + player.WALKSPEED / 10)
...
func weapon_bobbing_animation():
	var animation_speed = 1.0 / player.MAXSPEED
	var animation_value = player.MAXSPEED / 600 # 0.01
