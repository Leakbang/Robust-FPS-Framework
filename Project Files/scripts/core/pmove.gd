...
const GRAVITY : float = 60.0         # default: 80.0
const ACCELERATE : float = 4.0      # default: 10.0
const AIRACCELERATE : float = 0.25   # default: 0.7
const MOVEFRICTION : float = 8.0     # default: 6.0
const JUMPFORCE : float = 16.0       # default: 27.0
